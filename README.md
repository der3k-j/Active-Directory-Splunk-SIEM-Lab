...
![Active Directory & Splunk Lab Topology](docs/screenshots/Active%20Directory_Splunk%20Lab%20Topology.drawio.png)
...
- **Audit Logon/Logoff (Success & Failure):** Records all login attempts (Event IDs 4624 & 4625).
...
* **Active Directory & Network Fundamentals:** Setting up a Domain Controller from scratch and joining a Windows 11 workstation to `lab.local` significantly deepened my understanding of enterprise identity management and static IP networking. 
